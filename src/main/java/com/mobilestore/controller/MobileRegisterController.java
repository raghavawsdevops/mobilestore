...
public class MobileRegisterController extends HttpServlet {
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (fname.isEmpty() || lname.isEmpty() || pass.isEmpty() || confirmpass.isEmpty() || email.isEmpty()) {
            ...
            if (pass.equals(confirmpass)) {
                ...
                MobileUser portalNewUser = new MobileUser(fname, lname, pass, email);

                if (new MobileService().doRegistration(portalNewUser)) {
